  ...
  setNavigation() {
    ...
    this.backButton.addEventListener("click", () => {
      ...
      if (
        ...
        if (this.currentStage === "contact") {
          this.contactPanel.classList.remove("is-visible");
  ...
  flyToPosition = (key) => {
    ...
    switch (key) {
      ...
      case "rubikGroup":
        ...
        break;
      case "contact":
        this.contactPanel.classList.add("is-visible");
        ...
        break;
      case "linkedin":
        if (LINKEDIN_URL) window.open(LINKEDIN_URL, "_blank", "noopener,noreferrer");
        break;
      case "github":
        if (GITHUB_URL) window.open(GITHUB_URL, "_blank", "noopener,noreferrer");
        break;
      case "itchio":
        if (ITCHIO_URL) window.open(ITCHIO_URL, "_blank", "noopener,noreferrer");
        break;
    }
  };
